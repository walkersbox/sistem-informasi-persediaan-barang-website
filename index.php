...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="?page=barang_masuk">
            ...
            <li class="nav-item">
                <a class="nav-link" href="?page=barang_keluar">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            if(@$_GET['page'] == 'dashboard' || @$_GET['page'] == ''){
                include 'views/data_master/dashboard.php';
            } elseif (@$_GET['page'] == 'databarang') {
                include 'views/data_master/databarang.php';
            } elseif (@$_GET['page'] == 'jenisbarang') {
                include 'views/data_master/jenisbarang.php';
            } elseif (@$_GET['page'] == 'satuan') {
                include 'views/data_master/satuan.php';
            } elseif (@$_GET['page'] == 'barang_masuk') {
                include 'views/transaksi_barang/barang_masuk.php';
            } elseif (@$_GET['page'] == 'barang_keluar') {
                include 'views/transaksi_barang/barang_keluar.php';
            }
            ?>
            </div>
            <!-- Footer -->
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Tim Barokah 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
